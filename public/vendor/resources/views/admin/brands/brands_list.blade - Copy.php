                ...
                <div id="brand-image" class="tab-pane fade in active">
                  <div class="portlet">
                              ...
                              <div class="form">
                                <form class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <input type="text" class="form-control" placeholder="dyson">
                                    </div>
                                  </div>
                                  <div class="form-group">
                    ...
                    <div class="portlet-body">
                      ...
                      <input type="text" id="delete_brand_ids" value="0" />
                      
                          <table class="table table-hover table-striped">
                            <thead>
                              <tr>
                                <th width="1%"><input type="checkbox" id="select_msgs"/></th>
                                <th>#</th>
                                <th>Status</th>
                                <th>Title</th>
                                <th>Action</th>
                            ...
                            <tbody>
                              ...
                              <?php
								...
								?>
                                  <tr>
                                    <td><input type="checkbox" data-id="<?php echo $details->id; ?>" class="select_msgs"/></td>
                                    <td><?php echo $i; ?></td>
					...
					function set_brand_to_delete(brand_id)
					{
						obj = $('#delete_brand_ids');
						if(obj.val() == 0)
							obj.val(brand_id);
						else
					...
					{
						//alert(brand_id);
						$('#delete_brand_ids').val(brand_id);
					}
					
					function cancel_delete()
					{
						$('#delete_brand_ids').val(0);
					}
					...
					$(document).ready(function(){
						$('#select_msgs').click(function(){
							//alert('asd');
							//if($('.select_msgs').length() > 0)
							if($('#select_msgs').is(':checked'))
							{
								$('.select_msgs').prop('checked',true);
							}
							else
								$('.select_msgs').prop('checked',false);
						});	
					});
					
					function delete_selected()
					{
						$('#delete_brand_ids').val('');
						
						if($('.select_msgs:checked').length == 0)
						{
							alert('Select items to delete.');
							return false;
						}
						
						$('input.select_msgs').each(function(){
											
								if($(this).is(':checked'))
								{
									id = $(this).attr('data-id');
									
									if($('#delete_brand_ids').val() == '')
										$('#delete_brand_ids').val(id);
									else
									{
										$('#delete_brand_ids').val($('#delete_brand_ids').val()+','+id);	
									}
						...
						{		
							// open error popup
							$.colorbox({
									inline:true, href:".error_popup", open:true, width:"50%", height:"150px",
									onLoad: function() {
															$('#cboxClose').remove();
														}
							});		
					...
					function continue_delete_process(redirect_to)
					{	
						item_id = $('#delete_brand_ids').val();	
						...
						$.ajax({	   
							   ...
							   success : function(response){					
										window.location.href = base_url+"message/"+redirect_to;
							   }
						});	// end ajax	
					}
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <!--<p><strong>#1:</strong> dyson</p>-->
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> <a href="#" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                    </div>
                                  </div>
                                </div>
                              </div>
