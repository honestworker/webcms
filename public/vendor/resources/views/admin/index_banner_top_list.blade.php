                                    ...
                                    <div class="col-md-9">
                                      <div class="text-15px margin-top-10px"> <!--<img src="../images/homeslider/slide1.jpg" alt="Banner" class="img-responsive">-->
                                        ...
                                        <?php if($details->banner!='')
                                                 {?>
                                        <img  id="banner_image_<?php echo $details->id; ?>" alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/', $details->banner?>" class="img-responsive" />
                                        <?php }?>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      <?php if($details->banner!='')
                           {?>
                                    <p><img   alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/'. $details->banner?>"" class="img-responsive" /></p>
                          <?php } ?>
                                    <div class="form-actions">
