...
<?php  $animate = App\Http\Models\Front\Page::getFooteranimate(); ?>
	 
<!--<section id="facts" style="background:url('images/<?php if($animate[1]['image']['active']) echo $animate[1]['image']['img']; ?>') 50% 0 repeat-y fixed;">-->
<section id="facts">
     <div class="container">
        <div class="row">
