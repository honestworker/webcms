...
-->
                                <tr>
                                    ...
                                    <td style="text-align: right; padding-right: 10px" class="amount">{{ number_format($cartProducts['shippingTotal'], 2) }}</td>
                                </tr>
                                <tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="font-size:18px; text-align: right" class="amount-total">{{ number_format((($cartProducts['totalPrice'] + $gst + $cartProducts['shippingTotal']) - $discount), 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <div class="md-margin"></div>
