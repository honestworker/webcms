                                        ...
                                        <div class="sort-box"><span class="separator">Sort by:</span>
                                            <div class="btn-group select-dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="<?= url('products/' . $id.'/priceAsc/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Price : Low - High</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/priceDesc/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Price : High - Low</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/a-z/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Product Name : A - Z</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/z-a/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Product Name : Z - A</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/date/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Date</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/brand/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">Brand</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/new/'.$item.'/'.$page, $parameters = [], $secure = null); ?>">New Arrivals</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="toolbox-pagination clearfix">
                                        ...
                                        <ul class="pagination">
                                        	<?php if($page>1 and $totalPage>1){?>
                                        		<li><a href="<?= url('products/' . $id.'/'.$sort.'/'.$item.'/'.($page-1), $parameters = [], $secure = null); ?>"><i class="fa fa-angle-left"></i></a></li>
                                            <?php }?>
                                        	<?php for($i=1; $i<=$totalPage; $i++){ if($i==$page){ $active='active';}else{ $active='';}?> 
                                            	<li class="<?php echo $active;?>"><a href="<?= url('products/' . $id.'/'.$sort.'/'.$item.'/'.$i, $parameters = [], $secure = null); ?>"><?php echo $i;?></a></li>
                                            <?php }?>
                                            <?php if($totalPage>1 and $page<$totalPage){?>
                                        		<li><a href="<?= url('products/' . $id.'/'.$sort.'/'.$item.'/'.($page+1), $parameters = [], $secure = null); ?>"><i class="fa fa-angle-right"></i></a></li>
                                            <?php }?>
                                        </ul>
                                        <div class="view-count-box"><span class="separator">View:</span>
                                            <div class="btn-group select-dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="<?= url('products/' . $id.'/'.$sort.'/20/'.$page, $parameters = [], $secure = null); ?>">20 items</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/'.$sort.'/40/'.$page, $parameters = [], $secure = null); ?>">40 items</a></li>
                                                    <li><a href="<?= url('products/' . $id.'/'.$sort.'/60/'.$page, $parameters = [], $secure = null); ?>">60 items</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
