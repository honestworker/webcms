     ...
     <div class="single-room list mobile-extend">
           ...
           <div class="row">
                 <div class="col-md-6">
                   ...
                   Rooms: <span class="text-black"><b><?= $cart['rooms']?></b></span>
                   </div><!--/.col-md-6-->
                               ...
                               <table class="table checkout-table">
                                   ...
                                   <tbody>
                                     <?php
                                      ...
                                      <?php } ?>
                                       <tr>
                                           <td class="checkout-table-title text-right" colspan="3"></td>
                                           <td class="checkout-table-title text-black"><span class="alignleft">Subtotal</span></td>
                                           <td class="checkout-table-price text-black">RM <?= $total_amount ?><span class="sub-price">.00</span></span></td>
                                       </tr>
                                       <tr>
                                           <td class="checkout-table-title text-right" colspan="3"></td>
                                           ...
                                           ?>
                                           <td class="checkout-table-price text-danger">- RM <?= (($total_amount - $discount_price) / 100 * $p_disc) ?><span class="sub-price">.00</span></td>
                                       </tr>

                                       <tr>
                                           <td class="checkout-table-title text-right" colspan="3"></td>
                                           <td class="checkout-table-title text-black"><span class="alignleft">GST (6%)</span></td>
                                           <td class="checkout-table-price text-black"><span >RM {{ number_format($total_amount/100*6,2) }}<span class="sub-price"></span></span></td>
                                       </tr>
                                   </tbody>
                                   <tfoot>
                                     <tr>
                                          ...
                                          <td class="checkout-total-price cart-total"><b>RM <?= number_format($promo_d + ($total_amount / 100 * 6), 2) ?><span class="sub-price"></span></b></td>
                                       </tr>
                                   </tfoot>
                               </table>
