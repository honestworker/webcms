...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400,300italic,300,400italic,700,700italic'
          rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,300,300italic,400italic,600,600italic,700,700italic'
          rel='stylesheet' type='text/css'>
                    ...
                    <div class="col-md-12">
                        <div class="header-top-left">
                            <ul id="top-links" class="clearfix">
                                <li><a href="{{ url('accountedit') }}" title="My Account"> <i class="fa fa-user"></i>
                                        <span class="hide-for-xs">My Account</span></a></li>
                                <li>
                                ...
                                <li><a href="{{ url('/compare') }}" title="Compare List"> <i class="fa fa-bars"></i>
                                        <span class="hide-for-xs">Compare List</span></a></li>

                                <li><a href="{{ url('/cart') }}" title="My Cart"><i class="fa fa-shopping-cart"></i>
                                        <span class="hide-for-xs">My Cart</span></a></li>
                                <li><a href="{{ url('/checkout') }}" title="Checkout"><i class="fa fa-sign-out"></i>
                                        <span class="hide-for-xs">Checkout</span></a></li>
                            </ul>
                        </div>
                        <div class="header-top-right">
                            <div class="header-text-container pull-right">
                                ...
                                <p class="header-link">
                                    Hello, {{ Session::get('userFirstName') }} {{ Session::get('userLastName') }}&nbsp;&nbsp;<a
                                            href="{{ url('logout') }}">Logout</a></p>
                                <?php }else{ ?>
                                <p class="header-link"><a href="{{ url('login') }}">login</a>&nbsp;or&nbsp;<a
                                            href="{{ url('create_account') }}">create an account</a></p>
                                <?php }?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-xs-12 logo-container">
                        <h1 class="logo clearfix"><span>Your Friendly Electrical Appliances Store:: Tan Boon Ming Sdn Bhd</span>
                            <a href="{{ url('/') }}"
                               title="Your Friendly Electrical Appliances Store:: Tan Boon Ming Sdn Bhd"><img
                                        src="{{ asset('/public/front/images/index/logo.jpg') }}"
                                        alt="Your Friendly Electrical Appliances Store:: Tan Boon Ming Sdn Bhd"
                                        width="196" height="83"></a></h1>
                    </div>
                        ...
                        <div class="header-inner-right-wrapper clearfix">
                            ...
                            <div id="quick-access">
                                <form class="form-inline quick-search-form" role="form"
                                      action="{{ url('/saveSearchTerm') }}" method="get">
                                ...
                                <ul class="menu clearfix">
                                    <li><a class="active" href="<?= url('/', $parameters = [], $secure = null); ?>">
                                            <span class="hide-for-xs">
                                            	<img src="{{ asset('/public/front/images/home-icon.png') }}"
                                                     alt="home icon">
                                                ...
                                                @if($count > 1)
                                                    @if($category['image'])
                                                        <div class="mega-menu clearfix"
                                                             style="background-image: url({{ asset('/public/images/category/' . $category['image']) }}); background-position: 100% 100%; background-repeat: no-repeat; position: absolute; ">
                                                            @else
                                                                    ...
                                                                    @else
                                                                        <div class="col-2 mega-menu clearfix">
                                                                            ...
                                                                            @if($category['image2'])
                                                                                <div class="col-4">
                                                                                    <a href="{{ url('products/' . $category['category_id'] . '/new/') }} ">
                                                                                        <img src="{{ asset('/public/images/category/' . $category['image2']) }}"
                                                                                             class="img-responsive"
                                                                                             alt="{{ $category['alt_text2'] }}"/>
                                                                                    </a>
                                                                                </div>
                                                                            @endif
                                                                            @endif
                                                                            ...
                                                                            @foreach($category['sub_categories'] as $sub_categories)
                                                                                <div class="col-5">
                                                                                    <a href="{{ url('products/' . $sub_categories['category_id'].'/new/') }}"
                                                                                       class="mega-menu-title">{{ $sub_categories['title'] }}</a>
                                                                                    @if($sub_categories['sub_categories'])
                                                                                        <ul class="mega-menu-list clearfix">
                                                                                            @foreach($sub_categories['sub_categories'] as $lvl3_categories)
                                                                                                <li>
                                                                                                    <a href="{{ url('products/' . $lvl3_categories['category_id'].'/new/') }}">{{ $lvl3_categories['title'] }}</a>
                                                                                                </li>
                                                                                            @endforeach
                                                                                        </ul>
                                                                                    @endif
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12 widget">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3983.986191765057!2d101.676021!3d3.098329!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4f927fdab737f312!2sTAN+BOON+MING+SDN+BHD!5e0!3m2!1sen!2s!4v1415724613461"
                                width="100%" height="260" frameborder="0" style="border:0"></iframe>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12 footer-social-links-container">
                        <ul class="social-links clearfix">
                            ...
                            <li><a href="<?php echo $one['link']; ?>"
                                   class="social-icon <?php echo $one['icon']; ?>"></a></li>
                            <?php endif; ?>
                            <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
...
?>
<div class="modal fade" id="wishlist_model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
     aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix">
                    ...
                    <div class="col-md-2">
                        <img src="images/digital_gadget/digital_imaging/panasonic_DMC-GX1WGC_big2.jpg"
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="custom-checkbox">
                            <input type="checkbox" class="wishlist_id" name="wishlist_id[]" required
                                   value="{{ $wishlist_details->id }}"> <span class="checbox-container"><i
                                        class="fa fa-check"></i></span> {{ $wishlist_details->list_name }}
                        </div>
                        <?php
                        } // end foreach
                        ?>
                        ...
                        <div class="form-group">
                            <div class="input-group"><span class="input-group-addon"><i
                                            class="fa fa-list-alt"></i> <span class="input-text">Name</span></span>
                                <input type="text" class="form-control input-lg" name="list_name" id="list_name"
                                       placeholder="Create a list..." <?php echo $required; ?> >
                            </div>
                        </div>
                    </div>
