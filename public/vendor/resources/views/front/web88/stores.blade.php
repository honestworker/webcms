...
@section('stores_maps')
<script src="//maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&key=AIzaSyBcWR-yUIGC-1UtS-QyfKvC_XRFNrdhNys"></script>
...
$("#products-tabs-content > div:eq("+ind+")").find('.wbx-map').each(function(i, e){
   var address = $(e).attr('address');
    ...
    $.ajax({
  url: 'https://maps.google.com/maps/api/geocode/json?address=' + addressLabel + '&sensor=false&key=AIzaSyBcWR-yUIGC-1UtS-QyfKvC_XRFNrdhNys',
