                            ...
                            <?php
                             ...
                             foreach ($cart['product'] as $key => $value) {
                                 ...
                                 <tr>
                                     ...
                                     <td class="item-price-col" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top; font-size:15px; text-align:center;'><span class="item-price-special">RM <?= $value['sale_price'] ?>.<span class="sub-price">00</span></span></td>
                                     ...
                                     <td class="item-total-col" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top; font-size:15px; text-align:center;'><span class="item-price-special">RM <?= $value['sale_price'] * $value['qty'] ?>.<span class="sub-price">00</span></span>
                                     </td>
                                 </tr>
                             <?php } ?>
                              <tr>
