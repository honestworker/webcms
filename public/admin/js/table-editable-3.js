$(function () {
    ...
    $('#example3').on('click', 'a.edit', function (e) {
        e.preventDefault();
    ...
    function editRow(oTable, nRow) {
        ...
        rTds[5].innerHTML = '<a class="edit" href="" title="Save"><span class="label label-sm label-red"><i class="fa fa-save"></i>  </span></a>';
        rTds[6].innerHTML = '<a class="cancel" href="" title="Cancel"><span class="label label-sm label-green"><i class="fa fa-times-circle"></i></span></a>';
    }
