            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="error_alert" class="alert alert-danger alert-dismissable"
                             @if( Session::get('fail') )
                             style="display: block;">
                            <script>setTimeout(function () {
                                    $("body").animate({"scrollTop": 0}, 100);
                        ...
                        <div class="pull-left"> Last updated: <span
                                    class="text-blue">{{ date('d M, Y @ g.iA', strtotime($data['updated_at'])) }}</span>
                        </div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <div class="portlet">
                            ...
                            <div class="portlet-body">
                                <div id="page-header" class="wbx_info_header inline-edit" name="header"
                        ...
                        <div class="portlet">
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="wbx_edit_icons" class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-delivery-installation">Edit Terms &amp;
                                                Conditions</a>
                                    ...
                                    <div id="modal-edit-icon" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="form">
                                                        <form class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Icon <span
                                                                            class='require'>*</span></label>
                                                                <div class="col-md-6">
                                                                    <input type="text" class="form-control"
                                                                           id="inputContent" value="truck">
                                                                    <div class="help-block">Please refer here for more
                                                                        <a href="icon" target="_blank">icon options.</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-product-reservation">Edit Terms &amp; Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-credit-card">Edit Terms &amp; Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-instalment-plan">Edit Terms &amp; Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-extended-warranty">Edit Terms &amp; Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-product-exchange">Edit Terms &amp; Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 service-box-container small-services">
                                        <div class="services-box">
                                            ...
                                            <a href="#" class="label label-primary" data-toggle="modal"
                                               data-target="#modal-accessories-spare-parts">Edit Terms &amp;
                                                Conditions</a>
                                            <div class="sm-margin"></div>
                                        </div>
                                    </div>
                                ...
                                <div id="modal-delivery-installation" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 id="modal-login-label2" class="modal-title">Edit Terms &amp;
                                                    Conditions</h4>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="form-actions">
                                                    <div class="col-md-offset-5 col-md-8"><a href="javascript:void(0);"
                                                                                             data-descrid="0"
                                                                                             class="btn btn-red edit_term_condition">Save
                                ...
                                <div id="modal-product-reservation" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div id="modal-credit-card" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div id="modal-instalment-plan" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div id="modal-extended-warranty" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div id="modal-product-exchange" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div id="modal-accessories-spare-parts" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                {{ Form::open( [ 'id' => 'wbx_change_info', 'method' => 'post' ] ) }}
                                {{Form::close()}}
                        ...
                        <div class="form-actions none-bg"><a data="preview" href="#preview in browser/not yet published"
                                                             class="wbx_submit btn btn-red">Save &amp; Preview &nbsp;<i
                                        class="fa fa-search"></i></a>&nbsp; <a data="publish" href="#publish online"
                                                                               class="wbx_submit btn btn-blue">Save
                                &amp; Publish &nbsp;<i class="fa fa-globe"></i></a>&nbsp; <a href="#"
                                                                                             class="btn btn-green">Cancel
...
<script type="text/javascript">
    ...
    $('.edit_term_condition').click(function () {
        var cuurent_element = $(this);
        var id = $(this).attr('data-descrid');
        var content = $("[name='icon[" + id + "][descr]']").html();
        cuurent_element.attr('data-dismiss', 'modal');
        console.log(content);
        jQuery.ajax({
            url: 'TermCondition',
            type: 'POST',
            data: {
                type: 'saveTermCondition',
                term_id: id,
