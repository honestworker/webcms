                                          ...
                                          <div class="form">
											{{ Form::open( [ 'id' => 'wbx_change_info', 'class' => "form-horizontal" ] ) }}
                                              ...
                                              <div class="form-actions">
                                                <div class="col-md-offset-5 col-md-8"> <a href="#" data="header-settings" class="wbx_submit btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                              </div>
                                            {{Form::close()}}
                                          </div>
                                        </div>
