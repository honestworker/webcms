...
<div id="signin-page-content">
    {{ Form::open(['url' => 'admin/login', 'id' => 'login-form']) }}
        ...
        <div class="form-group">
            <div class="input-icon"><i class="fa fa-user"></i>{{ Form::text('email', null, [ 'placeholder' => 'Username', 'class' => 'form-control', 'required' => 'required' ]) }}</div>
        </div>
        <div class="form-group">
            <div class="input-icon"><i class="fa fa-key"></i>{{ Form::password('password', [ 'placeholder' => 'Password', 'class' => 'form-control', 'required' => 'required' ]) }}</div>
        </div>
        <div class="form-group">
            <div class="checkbox"><label>{{ Form::checkbox('remember', '1') }}&nbsp;
