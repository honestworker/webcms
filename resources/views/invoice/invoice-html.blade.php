                ...
                <table class="table checkout-table" style='border: 1px solid #e0e0e0;margin-bottom: 0;width: 100%;max-width: 100%;margin: 0 0 1.5em;background-color: transparent;border-spacing: 0;border-collapse: collapse;display: table;background-color: white; font-family: "Poppins", sans-serif;font-size: 15px;font-weight: 400;line-height: 1.45em;color: #787878;-webkit-font-smoothing: antialiased;'>
                    ...
                    <tbody>
                        ...
                        foreach ($cart['product'] as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="item-total-col" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top; font-size:15px; text-align:center;'><span class="item-price-special">RM <?= number_format((float) ($value['sale_price']*$cart['rooms']), 2, '.', '') ?><span class="sub-price"></span></span>
                                </td>
                            </tr>
                        <?php } 
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="checkout-table-price text-danger" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top; color:#a94442;"'>- RM <?= number_format($cart['discount_amount'], 2) ?><span class="sub-price" style="color:#a94442;"></span></td>
                        </tr>

                        <tr>
                            <td class="checkout-table-title text-right" colspan="2" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top;'></td>
                            <td class="checkout-table-title text-black" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top;'><span class="alignleft">SST ({{ $cart['tax_rate'] }}%)</span></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="checkout-total-price cart-total" style='font: 500 18px/20px "Poppins", sans-serif;text-transform: uppercase;padding: 5px;border-top: 1px solid #e0e0e0!important; border-right: 1px solid #e0e0e0!important;vertical-align: top; color: #78A994;'><b>RM <?= number_format($finalAmount, 2) ?><span class="sub-price"></span></b></td>
                        </tr>
                    </tfoot>
                </table>
