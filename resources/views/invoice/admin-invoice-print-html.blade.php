...
<div style="padding:0px; margin:0px;">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px; background:#fff;">
        <tr>
            ...
            <td width="550" align="left" valign="top" style="border-bottom:1px solid #ccc;"></td>
        ...
        <tr>
            ...
            <td width="450" align="right" valign="top" style="border-bottom:1px solid #ccc; padding:10px 0 20px;">
                <h2 style="padding:0px; margin:0px; color:#444645; font-size:15px;">Order #{{ $order->order_id }}</h2>
                <h2 style="padding:0px; margin-top:5px; color:#444645; font-size:15px;">Book ID: {{ $bookid }}</h2>
            </td>
        </tr>
        <tr>
