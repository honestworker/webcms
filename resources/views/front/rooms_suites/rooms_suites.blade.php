            ...
            <div class="carousel-inner">
                @foreach($banners as $key =>$banner)
                    <div class="item @if($key == 0) active @endif"
                         style="background-image:url('{{ asset('public/admin/images/banner/left/'.$banner->banner) }}')">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-full-width">
                            <div class="section-title-area text-center">
                                ...
                                <p class="section-title-dec">Our varied choice of rooms has been designed to suit your
                                    needs, be it for business travellers, family or group leisure.</p>
                        ...
                        @foreach($product as $products)
                            <div class="col-md-4 col-sm-6 col-xs-6">
                                <div class="single-room grid">
                                    ...
                                    @endif
                                    <img src="{{ asset('public/admin/products/medium/'.$products->thumbnail_image_1) }}"
                                         alt="deluxe room" class="room-thumb">
                                    <div class="room-info box-radius">
                                        @if ($products->sale_price)
                                            <h5>
                                                RM {{ number_format((float)$products->sale_price, 2, '.', '') }} {{ ($products->is_tax == 0)?"nett":"" }}
                                                / Night </h5>
                                        @else
