                ...
                <div class="col-md-12 room-single-content">
                    <div class="single-room list mobile-extend">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('dS M, Y', strtotime($userOrderDetails[0]->modifydate));?></td>
                                                   ...
                                                   <td>RM  {{ number_format($orderTax->totalPrice) }}</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                Rooms: <span class="text-black"><b>{{ $userOrderDetails[0]->rooms }}</b></span>
                            </div>
                            @endif
                            ...
                            <table class="table checkout-table table-responsive">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                          ...
                                          <?php $sbttl = $orderTax->subtotal * $orderTax->rooms; ?>
                                            ...
                                            <td class="item-price-col"><!--{{ number_format($orderTax->totalPrice, 2) }}-->{!! number_format($sbttl, 2) !!}</td>
                                            <?php
                                                $gst += ($orderProduct->gst);
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right; padding-right: 10px" class="checkout-table-price text-black">RM {!! number_format($sbttl, 2) !!}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="checkout-table-title text-black" colspan="1">
                                            <span class="alignleft">SST({{ $gst_rate }}%):</span>
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td  style="text-align:right; padding-right: 10px" class="checkout-total-price cart-total"><b>RM {{ number_format($orderTax->totalPrice,2) }}</b></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
