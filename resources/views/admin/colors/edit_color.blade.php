...
<div id="page-wrapper">
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Colors - Edit</li>
          </ol>
         </div>
	...
	<!-- BEGIN CONTENT -->       
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Colors <i class="fa fa-angle-right"></i> Edit</h2>
                        ...
                        <div class="portlet-body">
                          <div class="row">
                          	<div class="col-md-12">
                                ...
                                <form class="form-horizontal" method="post" action="{{ url('/web88cms/colors/updateColor/'.$colorDetails->id) }}" id="updateColorForm">
                                	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Status <span class="text-red">*</span></label>
                                                <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch2" style="height: 32px;">
                                                    <input type="checkbox" name="status" <?php if($colorDetails->status == '1'){ echo 'checked="checked"'; } ?>/>
                                                  </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" class="form-control" name="title" placeholder="Red" value="<?php echo $colorDetails->title; ?>">
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3"><input type="text" name="hex_code" class="colorpicker-default form-control" placeholder="#ff0000" value="<?php echo $colorDetails->hex_code; ?>"/></div>
                                            </div>
											
                                            <div class="form-actions">
                                              <div class="col-md-offset-5 col-md-7"> <a href="#" class="btn btn-red" onclick="$('#updateColorForm').submit()">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="{{ url('/web88cms/colors/list') }}" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
